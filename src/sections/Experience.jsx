    ...
    >
      <div className="max-w-7xl w-full">
        <h2 className="text-5xl font-bold text-center text-white mb-16">
          Experiencia <span className="text-green-500">Profesional</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Ismael Iriarte
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Cesar Betancourth
              <br />
              <strong>Cargo:</strong> diseñador web y maquetador Wordpress
              Prestashop
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Freddy Sanabria
              <br />
              <strong>Cargo:</strong> diseñador web y maquetador Wordpress
              Prestashop
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Andres Guerrero Acosta
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Juan Francisco Lopez
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Alexander Giraldo R
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Juan Carlos Ruiz
              <br />
              <strong>Cargo:</strong> diseñador de piezas de email marketing
              <br />
          ...
          >
            ...
            <p className="text-gray-300 leading-7">
              <strong>Jefe:</strong> Eduardo Quinero
              <br />
